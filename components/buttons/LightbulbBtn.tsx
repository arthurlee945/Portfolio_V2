  ...
  return (
    <BulbButton className={className} onClick={onClick} aria-pressed={ariaPressed}>
      <svg xmlns="http://www.w3.org/2000/svg" width="6.72in" height="6.72in" viewBox="0 0 6720 6720">
        ...
        <path d="M3131 4826c0,44 36,80 80,80 44,0 80,-36 80,-80l0 0 0 0c0,-9 1,-737 -340,-1296 116,-11 261,-16 406,-16 149,0 297,5 413,16 -341,560 -340,1288 -340,1296l0 0 0 0c0,44 36,80 80,80 44,0 80,-36 80,-80l0 0 0 0c0,-9 -1,-780 379,-1307 9,-11 16,-24 19,-39 7,-44 -22,-85 -66,-92l0 0c-131,-22 -348,-34 -564,-34 -207,0 -416,11 -552,33 -14,1 -27,6 -39,15 -36,26 -44,76 -18,112l0 0c384,527 383,1304 383,1313l0 0 0 0z" />
        <path d="M2950 5760c-44,0 -80,36 -80,80 0,44 36,80 80,80l820 0c44,0 80,-36 80,-80 0,-44 -36,-80 -80,-80l-820 0z" />
      </svg>
    </BulbButton>
  );
};
